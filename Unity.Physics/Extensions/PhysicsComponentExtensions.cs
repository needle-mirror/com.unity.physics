...
namespace Unity.Physics.Extensions
{
    ...
    {
        /// <summary>
        /// Scale the mass of the body using provided scale. NOTE: do not use this function to scale
        /// physics mass for simulation purposes, that is done automatically by physics systems. Use it
        /// if you need PhysicsMass in one of your functions if the body has scale component, and do not
        /// write back this mass to the body's entity components.
        /// </summary>
        ///
        /// <param name="pm">       The body's <see cref="PhysicsMass"/> component. </param>
        /// <param name="scale">    The body's <see cref="Scale"/> component. </param>
        ///
        ...
        public static PhysicsMass ApplyScale(in this PhysicsMass pm, in Scale scale)
        {
            ...
            if (!Math.IsApproximatelyEqual(scale.Value, 1.0f))
            {
                scaledBodyMass.CenterOfMass *= scale.Value;

                float absScale = math.abs(scale.Value);
        ...
        /// <see cref="GetEffectiveMass(in PhysicsMass, in Translation, in Rotation, in Scale, float3, float3)">
        /// </see>
        /// </summary>
        ///
        ...
        /// <param name="bodyScale">        The body' <see cref="Scale"/> component. </param>
        ...
        ///
        /// <param name="bodyMass">         The body's <see cref="PhysicsMass"/> component. </param>
        /// <param name="bodyScale">        The body's <see cref="Scale"/> component. </param>
        /// <param name="bodyPosition">     The body's <see cref="Translation"/> component. </param>
        /// <param name="bodyOrientation">  The body's <see cref="Rotation"/> component. </param>
        ///
        ...
        public static float3 GetCenterOfMassWorldSpace(in this PhysicsMass bodyMass, in Scale bodyScale, in Translation bodyPosition, in Rotation bodyOrientation) =>
            math.rotate(bodyOrientation.Value, bodyMass.CenterOfMass * bodyScale.Value) + bodyPosition.Value;

        /// <summary>
        /// Get the center of mass in world space. Assumes that there is no scale.
        /// <see cref="GetCenterOfMassWorldSpace(in PhysicsMass, in Scale, in Translation, in Rotation)"></see>
        /// </summary>
        ///
        /// <param name="bodyMass">         The body mass. </param>
        /// <param name="bodyPosition">     The body position. </param>
        ...
        public static float3 GetCenterOfMassWorldSpace(in this PhysicsMass bodyMass, in Translation bodyPosition, in Rotation bodyOrientation) =>
            bodyMass.GetCenterOfMassWorldSpace(new Scale { Value = 1.0f }, bodyPosition, bodyOrientation);
        ...
        public static void GetImpulseFromForce(in this PhysicsMass bodyMass, in Scale bodyScale, in float3 force, in ForceMode mode, in float timestep, out float3 impulse, out PhysicsMass impulseMass)
        {
            ...
            if (!Math.IsApproximatelyEqual(bodyScale.Value, 1.0f))
            {
        ...
        /// <see cref="GetImpulseFromForce(in PhysicsMass, in Scale, in float3, in ForceMode, in float, out float3, out PhysicsMass)"/>
        /// </summary>
        ///
        /// <param name="bodyMass">     The body mass. </param>
            ...
            in float upwardsModifier = 0, ForceMode mode = ForceMode.Force)
        {
            ...
            Math.ScaledMTransform worldFromBody = new Math.ScaledMTransform(new RigidTransform(bodyOrientation.Value, bodyPosition.Value), bodyScale.Value);
        ...
        /// <see cref="ApplyExplosionForce(ref PhysicsVelocity, in PhysicsMass, in PhysicsCollider, in Translation, in Rotation, in Scale, float, in float3, in float, in float, in float3, in CollisionFilter, in float, ForceMode)">
        /// </see>
        /// </summary>
        ///
        ...
        public static void ApplyExplosionForce(
            ...
            in float upwardsModifier = 0, ForceMode mode = ForceMode.Force)
        {
            bodyVelocity.ApplyExplosionForce(bodyMass, bodyCollider, bodyPosition, bodyOrientation, new Scale { Value = 1.0f }, explosionForce,
        ...
        {
            pv.ApplyImpulse(pm, t, r, new Scale { Value = 1.0f }, impulse, point);
        }
        ...
        /// <param name="impulse">      The impulse. </param>
        /// <param name="point">        The point. </param>
        public static void ApplyImpulse(ref this PhysicsVelocity pv, in PhysicsMass pm, in Translation t, in Rotation r, in Scale bodyScale, in float3 impulse, in float3 point)
        {
