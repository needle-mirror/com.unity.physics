...
namespace Unity.Physics.Tests.Authoring
{
    ...
    // Conversion system integration tests for physics bodies, including legacy physics
    class PhysicsBodyConversionSystem_SubScene_IntegrationTests
        : ConversionSystem_SubScene_IntegrationTestsFixture
    {
        ...
        [Test]
        public void PhysicsBodyConversionSystem_IsInSubScene_DoesNotThrow([ValueSource(nameof(GetMotionTypes))] BodyMotionType motionType)
        {
            float mass = 42f;
            CreateSubSceneAndValidate<PhysicsBodyAuthoring>(body =>
            {
                body.Mass = mass;
        ...
        // Test proper reset of rigid bodies built with PhysicsBodyAuthoring components contained in an open sub scene after leaving playmode
        [UnityTest]
        public IEnumerator PhysicsBodyConversionSystem_IsInSubScene_PlayModeAndReset() => BasePlayModeAndResetTest<PhysicsBodyAuthoring>(body =>
        {
            body.Mass = 42f;
...
#if LEGACY_PHYSICS
        [Test]
        public void LegacyRigidbodyConversionSystem_IsInSubScene_DoesNotThrow([ValueSource(nameof(GetMotionTypes))] BodyMotionType motionType)
        {
            float mass = 42f;
            CreateSubSceneAndValidate<LegacyRigidbody>(body =>
            {
                body.mass = mass;
        ...
        // Test proper reset of rigid bodies built with legacy Rigidbody components contained in an open sub scene after leaving playmode
        [UnityTest]
        public IEnumerator LegacyRigidbodyConversionSystem_IsInSubScene_PlayModeAndReset() => BasePlayModeAndResetTest<LegacyRigidbody>(body =>
        {
            body.mass = 42f;
