...
namespace Unity.Physics.Authoring
{
    ...
    static class DrawColliderUtility
    {
        ...
        public static void DrawPrimitiveCapsuleFaces(float radius, float cylinderHeight, float3 center, Quaternion orientation, RigidTransform wfc, ref ColliderGeometry cylinderGeometry, ref ColliderGeometry hemisphereGeometry, ColorIndex color, float uniformScale)
        {
            ...
            var halfHeight = new float3(0, cylinderHeight * 0.5f, 0);
            ...
            var invertedHemisphereScale = new float3(1.0f, -1.0f, 1.0f);
            var bottomHemisphereTransform = float4x4.TRS(center - halfHeight, orientation, invertedHemisphereScale * hemisphereShapeScale);
            ...
            try
            {
                ...
                PhysicsDebugDisplaySystem.Triangles(bottomHemisphereVerticesWorld, hemisphereGeometry.IndicesArray, color, true);
            }
            finally
            {
